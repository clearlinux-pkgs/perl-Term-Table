...
Source0  : https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Term-Table-0.023.tar.gz
...
%prep
%setup -q -n Term-Table-0.023
cd %{_builddir}/Term-Table-0.023
pushd ..
cp -a Term-Table-0.023 buildavx2
popd
