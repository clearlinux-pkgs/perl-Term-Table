...
Source0  : https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Term-Table-0.024.tar.gz
...
%prep
%setup -q -n Term-Table-0.024
cd %{_builddir}/Term-Table-0.024
pushd ..
cp -a Term-Table-0.024 buildavx2
popd
...
cp %{_builddir}/Term-Table-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Term-Table/b70b3b91dcf1142f43384b4363ee8507e397f11d || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Term-Table/b70b3b91dcf1142f43384b4363ee8507e397f11d
